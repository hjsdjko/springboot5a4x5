...
public class BingrenController {
	...
	public R login(String username, String password, String captcha, HttpServletRequest request) {
		BingrenEntity u = bingrenService.selectOne(new EntityWrapper<BingrenEntity>().eq("bingrenzhanghao", username));
		if(u==null || !u.getMima().equals(password)) {
			return R.error("账号或密码不正确");
		}
		
		String token = tokenService.generateToken(u.getId(), username,"bingren",  "病人" );
    ...
    public R register(@RequestBody BingrenEntity bingren){
    	...
    	BingrenEntity u = bingrenService.selectOne(new EntityWrapper<BingrenEntity>().eq("bingrenzhanghao", bingren.getBingrenzhanghao()));
		if(u!=null) {
    ...
    public R getCurrUser(HttpServletRequest request){
        ...
        BingrenEntity u = bingrenService.selectById(id);
	...
	@IgnoreAuth
    @RequestMapping("/list")
    public R list(@RequestParam Map<String, Object> params,BingrenEntity bingren, 
		HttpServletRequest request){
        EntityWrapper<BingrenEntity> ew = new EntityWrapper<BingrenEntity>();
