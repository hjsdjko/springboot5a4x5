...
public class BinglixinxiController {
    ...
    public R page(@RequestParam Map<String, Object> params,BinglixinxiEntity binglixinxi,
		...
		if(tableName.equals("bingren")) {
			binglixinxi.setBingrenzhanghao((String)request.getSession().getAttribute("username"));
		}
		if(tableName.equals("yisheng")) {
			binglixinxi.setYishenggonghao((String)request.getSession().getAttribute("username"));
		}
